...
<head>
    ...
    <title><?php echo htmlspecialchars($job['title']); ?> - Geonet Technologies Limites Careers</title>
        ...
        <div class="container">
            <div class="header-content">
                <div class="logo">
                    ...
                    <h1>Geonet Technologies Careers</h1>
                </div>
                <nav class="nav">
            ...
            <div class="job-main-content">
                ...
                <div class="card job-header-card">
                    ...
                    <div class="job-meta">
                        ...
                        <div class="job-meta-item">
                            <i class="fas fa-kenya-shillings"></i>
                ...
                <div class="card apply-card">
                    ...
                    <div class="card-content">
                        <?php if (!$isExpired): ?>
                            ...
                            <p class="apply-note">Application takes about 1-2 minutes to complete</p>
                        <?php else: ?>
                    ...
                    <div class="card-content">
                        ...
                        <div class="company-stats">
                            ...
                            <div class="company-stat">
                                ...
                                <span class="stat-value">21st December, 2007</span>
                            </div>
                        </div>
                    </div>
                </div>

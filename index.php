...
try {
    ...
    echo "<p>There was a problem connecting to the database. Please check your configuration.</p>";
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <div class="footer-logo">
                        <i class="fas fa-building"></i>
                        <span>Geonet Technologies Limited</span>
                    </div>
                ...
                <div class="footer-section">
                    <h4>Support</h4>
                    <ul>
                        <li><a href="https://geonet-tech.co.ke/contact-us/">Help Center</a></li>
                        <li><a href="https://geonet-tech.co.ke/contact-us/">Contact</a></li>
            ...
            <div class="footer-bottom">
                <p>&copy; 2025 Geonet Technologies Limited. All rights reserved.</p>
            </div>
        </div>
    </footer>
